...
function SignUp() {
  ...
  const findFormErrors = () => {
    ...
    if (!signEmail || signEmail === "")
      newErrors.signEmail = "* Email address is empty";
    else if (!signEmail.match(regexEmail))
      newErrors.signEmail = "* Invalid email address";

    if (!signPassword || signPassword === "")
      newErrors.signPassword = "* Password is empty";
    else if (signPassword.length > 30)
      newErrors.signPassword = "* Password is too long";

    if (!confirmPass || confirmPass === "")
      newErrors.confirmPass = "* Password not confirmed";
    else if (confirmPass !== signPassword)
              ...
              <div className="email-container">
                ...
                <Form.Group>
                  ...
                  <Form.Control
                    ...
                    className="input-fields"
                  >
                    <option value="guest" className="sign-option">
                      Guest &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    </option>
                    <option value="cook" className="sign-option">
                      Cook
                    </option>
                  </Form.Control>
                </Form.Group>
