        ...
        <div className="booking-container">
            <div className="icon-container">
                <div className="booking-details">
                    <span className="booking-icon"><FaMale /></span>
                    <p className="focus">number of participants</p>
                    <p>2 to 15 people</p>
                </div>
                <div className="booking-details">
                    <span className="booking-icon"><ImClock /></span>
                    <p className="focus">duration</p>
                    <p>3h</p>
                </div>
                <div className="booking-details">
                    <span className="booking-icon"><FaComment /></span>
                ...
                <div className="booking-details">
                    ...
                    <p>Depends on amount of participants</p>
                </div>
            </div>
            <div className="review-container">
                <span className="review-icon"><RiStarSmileLine /></span>
