   ...
   <div className="main">
    ...
    <h1 className="h1-text__list">CHOOSE YOUR WORKSHOP</h1>
     <div className="cards-flex">
       <div class="card_content">
          ...
          <Link to="/workshop/Indonesia" className="btn card_btn" to="/workshop">Discover More</Link>{" "}
        </div>
      ...
      <div class="card_content">
          ...
          <p className="card_text">Indonesia is centrally-located along ancient trading routes between the Far East, South Asia and the Middle East,</p>
          <Link to="/workshop/Congo" className="btn card_btn" to="/workshop">Discover More</Link>{" "}
      </div>
    </div>
    <div className="cards-flex_two">
      <div class="card_content">
          ...
          <p className="card_text">Indonesia is centrally-located along ancient trading routes between the Far East, South Asia and the Middle East,</p>
          <Link to="/workshop/HongKong" className="btn card_btn" to="/workshop">Discover More</Link>{" "}
      </div>
      <div class="card_content">
          <div className="card_image"><img className="img-cards" src={image4} alt=""/></div>
          <h2 className="card_title">Afganistan</h2>
          <p className="card_text">Indonesia is centrally-located along ancient trading routes between the Far East, South Asia and the Middle East,</p>
          <Link to="workshop/Afghanistan" className="btn card_btn" to="/workshop">Discover More</Link>{" "}
      </div>
    </div>
  </div>
